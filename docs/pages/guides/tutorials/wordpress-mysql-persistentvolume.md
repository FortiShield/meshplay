...
> **NOTE:** If this is your first time working with Meshplay Playground, consider starting with the [Exploring Kubernetes Pods with Meshplay Playground](https://docs-meshplay.khulnasoft.com/guides/tutorials/kubernetes-pods) tutorial first.
